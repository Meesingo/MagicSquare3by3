...
def calc(numbers):
    verbose_Print('Check success, continue onto iteration of first line\nThe target sum is ' + str(value_Calc.target) + ' and the central number is ' + str(value_Calc.enter) + '\n')
    # Assemble the first line using assemble_Line1(numbers)
    success_Line1 = for_Calc.assemble_Line1(numbers)
    ...
    if success_Line1 == []:
        ...
        success_Line3 = for_Calc.assemble_Line3(success_Line1)
        ...
        if success_Line3 == []:
            ...
            success = for_Calc.assemble(success_Line3)
